...
@Log4j
public class TransactionWithdrowCreatorHandler implements HttpHandler {

    private BankAccountService bankAccountService;
    private TransactionService transactionService;
    private ATMService atmService;

    public TransactionWithdrowCreatorHandler(BankAccountService bankAccountService, TransactionService transactionService, ATMService atmService) {
        ...
        try {
            ...
            if (atmReceiver == null) {
                ...
                if (!transactionAbility(bankAccountSender, amount, commission)) {
                    ...
                    transaction_real_id = transactionService.createTransaction("WITHDRAW", amount, false, commission, bankAccountSender, null, atmReceiver, DateTimeUtils.getServerLocalTime().toString());
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
